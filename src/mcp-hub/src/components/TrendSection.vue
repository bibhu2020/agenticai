  ...
  <section class="trend-section">
    ...
    <div class="trend-container">
      ...
      <div class="trend-chart">
         <svg viewBox="0 0 1000 140" class="sparkline" preserveAspectRatio="none" @mousemove="handleHover" @mouseleave="hoverInfo = null">
            <!-- Grid -->
            <line v-for="tick in [0, 40, 80, 120]" :key="tick" x1="0" :y1="130 - tick" x2="1000" :y2="130 - tick" stroke="var(--border)" stroke-width="0.5" stroke-dasharray="4,4" />
            ...
            <!-- Hover Vertical -->
            <line v-if="hoverInfo" :x1="hoverInfo.x" y1="0" :x2="hoverInfo.x" y2="140" stroke="var(--accent)" stroke-width="1.5" stroke-dasharray="2,2" vector-effect="non-scaling-stroke" />
         </svg>
...
const getCharts = computed(() => {
  ...
  return datasets.map((ds, idx) => {
    ...
    if (points.length > 0) {
      ...
      areaPath = d + ` L ${points[points.length-1].x} 130 L ${points[0].x} 130 Z`
    }
